    ...
    t.toggleHeader = function() {
        ...
        function n(n) {
            m || (requestAnimationFrame(function() {
                ...
                i = t(a);
                if (1 == i ? (c.addClass("home-link-hide"), l.addClass("back-top-show"), d.addClass("header-sidebar-menu-black")) : -1 == i && (c.removeClass("home-link-hide"), o.removeClass("banner-show"), l.removeClass("back-top-show"), d.removeClass("header-sidebar-menu-black")), s) {
                    var r = e(a);
...
function(e, t) {
    ...
    t.initMobile = function() {
        function e(e) {
            e.matches ? (console.log("mobile"), document.body.addEventListener("touchstart",
